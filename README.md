...
* [Faker](https://github.com/joke2k/faker) ⭐ 19,376 | 🐛 32 | 🌐 Python | 📅 2026-08-21: a Python package that generates fake data (Note: this tool does not generate synthetic data but offers dummy data).
...
* [CTGAN](https://github.com/sdv-dev/CTGAN) ⭐ 1,560 | 🐛 39 | 🌐 Python | 📅 2026-08-10: SDV’s collection of deep learning-based synthetic data generators for single table data.
* [Copulas](https://github.com/sdv-dev/Copulas) ⭐ 651 | 🐛 55 | 🌐 Python | 📅 2026-08-24: a Python library for modeling multivariate distributions and sampling from them using copula functions.
