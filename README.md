...
* [Faker](https://github.com/joke2k/faker) ⭐ 19,398 | 🐛 27 | 🌐 Python | 📅 2026-09-01: a Python package that generates fake data (Note: this tool does not generate synthetic data but offers dummy data).
* [YData](https://github.com/ydataai/ydata-synthetic) ⭐ 1,656 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-09-03: synthetic structured data generator by YData, a commercial vendor.
* [CTGAN](https://github.com/sdv-dev/CTGAN) ⭐ 1,566 | 🐛 39 | 🌐 Python | 📅 2026-09-08: SDV’s collection of deep learning-based synthetic data generators for single table data.
