...
* [Faker](https://github.com/joke2k/faker) ⭐ 19,389 | 🐛 30 | 🌐 Python | 📅 2026-09-01: a Python package that generates fake data (Note: this tool does not generate synthetic data but offers dummy data).
* [YData](https://github.com/ydataai/ydata-synthetic) ⭐ 1,654 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-09-03: synthetic structured data generator by YData, a commercial vendor.
