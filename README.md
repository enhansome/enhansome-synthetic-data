# awesome-synthetic-data with stars

A curated list of awesome synthetic data tools (open source and commercial).

Inspired by [Awesome Synthetic Data](https://github.com/gretelai/awesome-synthetic-data) ⚠️ Archived
...
* [Faker](https://github.com/joke2k/faker) ⭐ 19,382 | 🐛 33 | 🌐 Python | 📅 2026-08-21: a Python package that generates fake data (Note: this tool does not generate synthetic data but offers dummy data).
* [YData](https://github.com/ydataai/ydata-synthetic) ⭐ 1,654 | 🐛 64 | 🌐 Jupyter Notebook | 📅 2026-04-23: synthetic structured data generator by YData, a commercial vendor.
* [CTGAN](https://github.com/sdv-dev/CTGAN) ⭐ 1,562 | 🐛 39 | 🌐 Python | 📅 2026-08-10: SDV’s collection of deep learning-based synthetic data generators for single table data.
* [Copulas](https://github.com/sdv-dev/Copulas) ⭐ 652 | 🐛 55 | 🌐 Python | 📅 2026-08-24: a Python library for modeling multivariate distributions and sampling from them using copula functions.
...
* [DP\_WGAN-UCLANESL](https://github.com/nesl/nist_differential_privacy_synthetic_data_challenge) ⭐ 26 | 🐛 2 | 🌐 Python | 📅 2019-05-30: this solution trains a Wasserstein generative adversarial network (w-GAN) that is trained on the real private dataset.
* [mirrorGen](https://github.com/DataResponsibly/MirrorDataGenerator) ⭐ 25 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2022-06-22: a python tool that generates synthetic data based on user-specified causal relations among features in the data.
